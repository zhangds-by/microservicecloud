...
public class TableUtil {
     ...
     * 保存生成HTML时需要被忽略的单元格
     */
    private static List<String> omitCellsList = new ArrayList<>();
     ...
     * @return
     */
    public static String generateOmitCellStr(int row, int col) {
        return row + ":" + col;
    }
     ...
     * @param col
     */
    public static void addOmitCell(int row, int col) {
        String omitCellStr = generateOmitCellStr(row, col);
        omitCellsList.add(omitCellStr);
    }

    public static boolean isOmitCell(int row, int col) {
        String cellStr = generateOmitCellStr(row, col);
        return omitCellsList.contains(cellStr);
    }

    public static String readTable(XWPFTable table) throws IOException {
        // 表格行数
